...
export const applyForJob = async (candidate_id, job_id, resumeUrl, // Now storing Cloudinary URL
status) => {
...
export const getJobsWithApplications = async (employer_id) => {
    const jobApplicationRepository = AppDataSource.getRepository(JobApplication);
    const jobRepository = AppDataSource.getRepository(Job);
...
export const getJobsAppliedByCandidate = async (candidate_id) => {
    const jobApplicationRepository = AppDataSource.getRepository(JobApplication);
    const jobApplications = await jobApplicationRepository.find({
