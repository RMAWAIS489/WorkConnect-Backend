...
export const createCandidate = async (userId, candidateData) => {
...
export const getCandidateResume = async (userId) => {
    const candidateRepository = AppDataSource.getRepository(Candidate);
...
export const updateCandidate = async (userId, updatedData) => {
    const candidateRepository = AppDataSource.getRepository(Candidate);
    const candidate = await candidateRepository.findOne({
        where: { user: { id: userId } },
    });
