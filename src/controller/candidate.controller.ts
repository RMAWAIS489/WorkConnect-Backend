...
export const getCandidateResumeById = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const fetchAllCandidatesController = async (req: Request, res: Response) => {
  try {
...
export const fetchCandidateByUserId = async (req: Request, res: Response) => {
  try {
    const userId = parseInt(req.params.userId);
