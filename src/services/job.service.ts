...
export const getAllJobsbyfiltering = async (title?: string, location?: string, salary_range?: number) => {
  const jobRepository = AppDataSource.getRepository(Job);
...
export const updateJob = async (jobId: number, updatedData: Partial<Job>) => {
  const jobRepository = AppDataSource.getRepository(Job);
...
export const updateEmploymentStatus = async (jobId: number, employment_status: string): Promise<Job> => {
  const jobRepository = AppDataSource.getRepository(Job);
...
export const getActiveJobsCountByUser = async (userId: number) => {
  const jobRepository = AppDataSource.getRepository(Job);
